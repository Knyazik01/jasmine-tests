Задачи
[http://dkab.github.io/jasmine-tests/](http://dkab.github.io/jasmine-tests/)

[Step 1](http://dkab.github.io/jasmine-tests/?spec=1)
...
[Step 2](http://dkab.github.io/jasmine-tests/?spec=2)
...
[Step 3](http://dkab.github.io/jasmine-tests/?spec=3)
...
[Step 4](http://dkab.github.io/jasmine-tests/?spec=4)
...
[Step 5](http://dkab.github.io/jasmine-tests/?spec=5)
Частичное применение (partial application)
вики: [https://ru.wikipedia.org/wiki/Частичное_применение](https://ru.wikipedia.org/wiki/Частичное_применение)
...
Кстати, имеющийся в новых версиях JS метод bind() тоже может делать частичное применение: [http://frontender.info/partial-application-in-javascript-using-bind/](http://frontender.info/partial-application-in-javascript-using-bind/) Но ты должен обойтись без его использования, и написать свой велосипед.

[Step 6](http://dkab.github.io/jasmine-tests/?spec=6)
...
[Step 7](http://dkab.github.io/jasmine-tests/?spec=7)
...
В библиотеках тоже есть такой метод: [http://lodash.com/docs#bind](http://lodash.com/docs#bind)

[Step 8](http://dkab.github.io/jasmine-tests/?spec=8)
Напиши функцию pluck, которая берет массив объектов и возвращает массив значений определенного поля.
Такая функция есть в lodash: [http://lodash.com/docs#pluck](http://lodash.com/docs#pluck)
Функция не должна изменять исходный массив.

[Step 9](http://dkab.github.io/jasmine-tests/?spec=9)
...
Функция не должна изменять исходный массив.
Аналог из lodash: [http://lodash.com/docs#filter](http://lodash.com/docs#filter) В новых браузерах у массивов есть метод filter.

[Step 10](http://dkab.github.io/jasmine-tests/?spec=10)
...
```javascript
var a = function (..) { ... }; // создаем новую функцию и помещаем ссылку в a
a(); // вызываем
